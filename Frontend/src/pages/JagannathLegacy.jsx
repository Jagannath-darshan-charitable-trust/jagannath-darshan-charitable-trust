        ...
        <div className="container-trust mx-auto max-w-4xl space-y-6 px-4">
          ...
          <div className="grid gap-8 md:grid-cols-[1fr_300px]">
            <div className="space-y-6">
              <p className="font-body text-base leading-relaxed text-muted-foreground text-left md:text-justify">
                The philosophy of Lord Jagannath teaches us that true devotion is expressed not through rituals alone but through service to all living beings. The cow, considered sacred in Vedic culture, holds a special place in this tradition. Gau Seva is seen as an act of worship, a way of expressing gratitude to the divine mother who nourishes all. Our Sri Jagannath Gosala initiative is inspired by this very principle - to protect, care for, and honor the sacred cow as an integral part of our spiritual ecosystem.
              </p>
              <p className="font-body text-base leading-relaxed text-muted-foreground text-left md:text-justify">
